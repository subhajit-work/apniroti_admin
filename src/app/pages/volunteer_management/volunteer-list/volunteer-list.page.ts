...
export class VolunteerListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'volunteer/header';
    
        // table list data url name
        this.listing_url = 'volunteer/return_index';


        this.onHeaderData(this.headerUrlapi);
        
        // getlist data url name
        // this.getlist('volunteer/getlist');
