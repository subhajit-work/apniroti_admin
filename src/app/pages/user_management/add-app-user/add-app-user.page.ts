...
@Component({
  ...
  templateUrl: './add-app-user.page.html',
  styleUrls: ['./add-app-user.page.scss'],
})

export class AddAppUserPage implements OnInit, OnDestroy {
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'appuser/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'appuser/return_add'
      }
