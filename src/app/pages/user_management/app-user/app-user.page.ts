...
@Component({
  ...
  styleUrls: ['./app-user.page.scss'],
})

export class AppUserPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'appuser/header';
    
        // table list data url name
        this.listing_url = 'appuser/return_index';


        this.onHeaderData(this.headerUrlapi);
        
        // getlist data url name
        // this.getlist('appuser/getlist');
